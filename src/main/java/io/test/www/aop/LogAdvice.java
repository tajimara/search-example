...
/**
 * Created by jihoon on 2017. 3. 16..
 */
...
//
//
//            if(arg instanceof SocialUserDetails) {
//                System.out.println(((SocialUserDetails) arg).getUserName().toString());
//            }
//
...
//        System.out.println("LogAdvice 서비스입니다. 입니다.");
        return result;
    }

    @Pointcut("execution(* io.test.www.service.common..*.*(..))")
